  ...
  export default {
    ...
    methods: {
      ...
      delTag(params) {
        ...
        this.selectMeasureValue.splice(index, 1)
      },
      initPage() {
      ...
      loadEchart1() {
        ...
        console.log(legendData, '1图里数据')
        console.log(xData, '2图里数据')
        console.log(seriesData, '3图里数据')
    ...
    watch: {
      'selectMeasureValue': function (nVal) {
        this.getEchartData()
      }
    },
    created() {
